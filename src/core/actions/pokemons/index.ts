...
export const getAllPokemons: ActionCreator<PokemonsSet> = (
...
export const addPokemon: ActionCreator<PokemonSet> = (
  favoriteList: PokemonType[]
) => {
  return {
...
export const addPokemonToFavoriteList =
  (favoriList: PokemonType[], pokemon: string) =>
