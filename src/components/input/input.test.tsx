...
test('test userValues updating input value', () => {
    ...
    fields.map((field: FieldProps, index: number) => {
        ...
        expect(screen.queryByTestId('test-span') as HTMLElement | null).not.toBeInTheDocument();
    });
});
...
test('test validation', () => {
    ...
    fields.map((field: FieldProps, index: number) => {
        ...
        expect(screen.getAllByTestId('test-span')[index] as HTMLElement).toBeInTheDocument();
